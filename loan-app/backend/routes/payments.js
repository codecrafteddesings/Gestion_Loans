...
const Payment = require('../models/Payment');
const Loan = require('../models/Loan');
const Cliente = require('../models/Cliente');   // Esto podría ser útil para futuras operaciones con clientes

exports.getPayments = async (req, res) => { // El parámetro req se puede usar en el futuro para obtener datos de la solicitud
    try {
        const payments = await Payment.find().populate('clientId', 'name');
        res.json(payments);
    } catch (error) {
